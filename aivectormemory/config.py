...
W_SIM = float(os.getenv("AIVM_W_SIM", "0.55"))
W_REC = float(os.getenv("AIVM_W_REC", "0.30"))
W_FREQ = float(os.getenv("AIVM_W_FREQ", "0.15"))
SIMILARITY_FLOOR = float(os.getenv("AIVM_SIMILARITY_FLOOR", "0.85"))
FTS_FALLBACK_SIM = float(os.getenv("AIVM_FTS_FALLBACK_SIM", "0.3"))
